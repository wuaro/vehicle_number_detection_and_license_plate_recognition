...
def detect(opt,save_img=False):
    ...
    imgsz = check_img_size(imgsz, s=model.stride.max())  # 检查图片尺寸
    if half:
        model.half()  # to FP16
...
def main(s='./inference/images'):
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', nargs='+', type=str, default='./weights/Final_yolo.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default= s, help='source')  # file/folder, 0 for webcam
